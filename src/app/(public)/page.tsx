...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#111729] font-sans text-[#F6F1F1] antialiased">
      ...
      >
        <div className="pointer-events-none absolute -right-40 -top-40 h-[36rem] w-[36rem] rounded-full bg-[#404D74]/30 blur-[120px]" />
        <div className="pointer-events-none absolute -left-40 top-1/3 h-[28rem] w-[28rem] rounded-full bg-[#5B688D]/20 blur-[120px]" />

        <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-8">
            <div className="lg:col-span-6">
              <div className="mb-7 inline-flex items-center gap-2 rounded-full border border-[#CEBEA6]/30 bg-[#CEBEA6]/5 px-4 py-1.5 text-xs font-medium tracking-wide text-[#CEBEA6]/90">
                <span className="h-1.5 w-1.5 rounded-full bg-[#CEBEA6]" />
                Consultoria · Estrutura · Alavancagem
              </div>

              <h1
                className="text-5xl font-bold leading-[1.02] text-[#FCFBF8] [text-wrap:balance] sm:text-6xl lg:text-[4.4rem]"
                style={serif}
              >
                Acabe com o caos
                <br />
                operacional e{' '}
                <span className="italic text-[#CEBEA6]">alavanque</span> o seu
                negócio.
              </h1>

              <p className="mt-7 max-w-xl text-lg leading-relaxed text-[#F6F1F1]/70">
                A Velten organiza os processos da sua empresa, estrutura a gestão
                e direciona o crescimento — para que o fundador deixe de apagar
                incêndios e volte a liderar com clareza e método.
              </p>

              <div className="mt-9 flex flex-col gap-4 sm:flex-row">
                <a
                  href="#contato"
                  className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-b from-[#EFE5D9] to-[#CEBEA6] px-7 py-3.5 text-base font-semibold text-[#111729] shadow-xl shadow-[#CEBEA6]/20 transition-all hover:from-[#FCFBF8] hover:to-[#EFE5D9]"
                >
                  Falar com Consultor
                ...
                <a
                  href="#servicos"
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 px-7 py-3.5 text-base font-medium text-[#F6F1F1]/80 transition-all hover:border-[#CEBEA6]/40 hover:text-[#FCFBF8]"
                >
                  Conhecer os pilares
                </a>
              </div>

              <div className="mt-10 flex items-center gap-8 text-sm text-[#F6F1F1]/50">
                <div>
                  <span className="text-2xl text-[#FCFBF8]" style={serif}>
                    +120
                  </span>
                  <br />
            ...
            <div className="lg:col-span-6">
              <div className="relative">
                <div className="relative rounded-3xl border border-white/10 bg-gradient-to-br from-[#262D41] to-[#111729] p-6 shadow-[0_0_120px_-30px_rgba(91,104,141,0.6)]">
                  <div className="mb-5 flex items-center justify-between">
                    <div>
                      <p className="text-xs uppercase tracking-widest text-[#F6F1F1]/40">
                        Painel de Performance
                      </p>
                      <p className="text-xl text-[#FCFBF8]" style={serif}>
                        Visão Estratégica
                      </p>
                    </div>
                    <span className="grid h-9 w-9 place-items-center rounded-lg bg-[#CEBEA6]/10 text-[#CEBEA6]">
                  ...
                  <div className="mb-4 grid grid-cols-2 gap-3">
                    <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                      <div className="flex items-center justify-between text-xs text-[#F6F1F1]/40">
                        <span>Receita</span>
                        <TrendingUp
                          className="h-4 w-4 text-[#CEBEA6]"
                          strokeWidth={1.75}
                        />
                      </div>
                      <p className="mt-2 text-3xl text-[#FCFBF8]" style={serif}>
                        R$ 2,8M
                      </p>
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                      ...
                      <p className="mt-1 text-xs text-[#F6F1F1]/40">
                        processos mapeados
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mb-4 rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    <div className="mb-3 flex items-center justify-between">
                      ...
                      <p className="text-xs text-[#CEBEA6]">2026</p>
                    </div>
                    <div className="flex h-24 items-end gap-2">
                      <div className="flex-1 rounded-t bg-[#404D74]/40" style={{ height: '38%' }} />
                      <div className="flex-1 rounded-t bg-[#404D74]/50" style={{ height: '52%' }} />
                      <div className="flex-1 rounded-t bg-[#5B688D]/60" style={{ height: '46%' }} />
                      <div className="flex-1 rounded-t bg-[#5B688D]/70" style={{ height: '64%' }} />
                      <div className="flex-1 rounded-t bg-[#EFE5D9]/70" style={{ height: '78%' }} />
                      <div className="flex-1 rounded-t bg-gradient-to-t from-[#CEBEA6] to-[#EFE5D9]" style={{ height: '100%' }} />
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 rounded-2xl border border-white/10 bg-white/[0.03] p-4">
                    <div
                      ...
                      style={{
                        background:
                          'conic-gradient(#CEBEA6 0% 82%, rgba(255,255,255,0.08) 82% 100%)',
                      }}
                    >
                      <div
                        className="absolute inset-[6px] grid place-items-center rounded-full bg-[#262D41] text-sm text-[#FCFBF8]"
                        style={serif}
                      >
                        82%
                      </div>
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-[#F6F1F1]/50">
                        14 de 17 iniciativas concluídas no prazo
                      </p>
                    </div>
                  </div>
                </div>
